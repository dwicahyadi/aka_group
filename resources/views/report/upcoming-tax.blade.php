        ...
        <div class="row align-items-center  mb-30">
            <div class="col-md-6">
                <div class="title d-flex align-items-center flex-wrap mb-30">
                    <h2 class="mr-40">Jadwal Pajak</h2>
                </div>
            </div>
        </div>
        <!-- end row -->
    ...
    <div class="card-styles" >
        <div class="card-style-3 mb-30">
            <div class="card-content" id="section-to-print" style="width: 100%">
                <h6 class="mb-25">Jadwal Pajak tanggal {{ request('start_date') ?? date('d M Y') }} s.d {{ request('end_date') ?? date('d M Y') }}                </h6>
                <div class="table-wrapper table-responsive">
                    <table class="table striped-table" style="width: 100%">
                        <thead>
                        <tr >
                            <th><h6>Jadwal Pajak</h6></th>
